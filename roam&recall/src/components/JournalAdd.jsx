...
function JournalAdd({ navigate, onSave, destination }) {
  ...
  return (
    <main className="page-section add-entry-page">
      <button className="back-link" onClick={() => navigate('journal')}>
        ← Back
      </button>
      ...
      <div className="add-entry-card">
          ...
          <div className="star-rating">
            {[1, 2, 3, 4, 5].map((star) => (
              <span
                ...
                style={{ color: star <= rating ? 'var(--rose)' : 'var(--tan)' }}
              >
                {star <= rating ? '★' : '☆'}
              </span>
            ))}
        ...
        <div className="add-entry-actions">
          <button className="btn-cancel-entry" onClick={() => navigate('journal')}>
            Cancel
          </button>
          <button className="btn-save-entry" onClick={handleSubmit}>
            Save Entry
          </button>
        </div>
      </div>
