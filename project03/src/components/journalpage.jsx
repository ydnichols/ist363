    ...
    return (
      <main className="page-section">
        <div className="journal-top-row">
          ...
          <button className="btn-add-entry" onClick={() => navigate('journal-add')}>
            + Add Entry
          </button>
        </div>
        ...
        <div className="timeline">
          {journal.length === 0 && (
            <p className="no-more-entries">No journal entries yet.</p>
          )}
            ...
            <div key={index} className="timeline-group">
              ...
              <div className="journal-entry-card">
                <div className="entry-text">
                  ...
                  <p className="entry-preview">Rating: {'★'.repeat(entry.rating)}{'☆'.repeat(5 - entry.rating)}</p>
                </div>
          ...
          {journal.length > 0 && (
            <p className="no-more-entries">No more entries.</p>
          )}
        </div>
      </main>
    )
